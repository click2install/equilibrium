...
function Player(name, x, y) {
  ...
  this.hitboxSize = Player.DEFAULT_WEIGHT;
...
Player.FORCE_ACCELERATION = 0.002;
Player.VELOCITY_DAMAGE_THRESHOLD = 0.012;
...
//      var velocityMagnitudeSquared = Util.getEuclideanDistance2(
//        0, 0, entity.vx, entity.vy);
//      if (velocityMagnitudeSquared > Player.VELOCITY_DAMAGE_THRESHOLD) {
//        console.log(velocityMagnitudeSquared * 1000);
//      }
      this.vx = 0;
      this.vy = 0;
      var angle = Math.atan2(entity.y - this.y, entity.x - this.x);
      var minDistance = this.hitboxSize + entity.hitboxSize + 1;
      this.x = entity.x - Math.cos(angle) * minDistance;
      this.y = entity.y - Math.sin(angle) * minDistance;
    }
  }
